        ...
        description="Join Nymb's Telegram mini-app now.
            ...
            <div className="inline-flex sm:gap-10">
                ...
                <a
                    ...
                    target="_blank"
                    className="w-full sm:w-fit text-center text-lg font-pixel text-black px-6 py-4 rounded-none bg-linear-to-b from-[#ADFA4B] via-[#B6FF00] to-[#B6FF00] font-normal uppercase tracking-[0.12rem] -ml-3"
                >
                    OPEN APP
                </a>
            </div>
